...
class LinearEvaluation(LightningModule):
    def __init__(self, args, encoder: nn.Module, hidden_dim: int, output_dim: int):
        ...
        self.average_precision = torchmetrics.AveragePrecision(task='multiclass', num_classes=10)
    ...
    def configure_optimizers(self) -> dict:
        optimizer = torch.optim.Adam(
            [
                ...
                {'params': self.model.parameters(), 'lr': self.hparams.finetuner_learning_rate},
            ],
